...
ChapterNumber: 01
TargetWords: 2000-3000
ContinuityNotes: Introduces protagonist, sets opening image, inciting incident hinted
FocalCharacter: Protagonist Name

Example opening (2-3 sentences)
He had never expected mornings to feel so small. The town kept its secrets in thin layers—coffee steam, a line of faded storefronts, the way people learned to look away.

Checklist for contributors
- Filename follows NN-title.md and is placed in chapters/.
- Header includes Title, ChapterNumber, TargetWords, ContinuityNotes, and FocalCharacter.
